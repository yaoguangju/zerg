...
class Order
{
    protected $oProducts; // 订单商品列表（客户端传来的）
    protected $products; // 从数据库里面查询出来的商品信息   用来做对比，做库存量的检测
    protected $uid;
    ...
    private function getOrderStatus()
    {
        $status = [
            'pass' => true,
            'orderPrice' => 0, // 所有商品价格的总额
            'pStatusArray' => [] // 用来保存订单的详细的信息
        ];
...
//    ];
    ...
    private function getProductsByOrder($oProducts)
    {
        ...
        // 为了避免循环查询数据库  visible用来指明显示那些字段 转化为数组
